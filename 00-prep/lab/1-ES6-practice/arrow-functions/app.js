...
// this is the additional Student {name: "Joe", age: "Schmoe", hometown: 100} that shows up when you console log "this"
// 2. What is "this" when joe.scopeArrow() is invoked?
// this time "this" is the window {postMessage}... that pops up when you console log this 
// 3. Explain why "this" is different when an arrow function is used.
// since one was used in a regular function and the other was used in an arrow function they do not follow the smae rules allowing them to have diffrent results. 
